...
def update_everything():
    ...
    if run_replacements_in_batch:
        ...
        run_all_replacements()
    subprocess.check_call(["git", "am", "-3", "libraries/scripts/updater/0001-Patch-to-update-shared-libraries.patch"])
    subprocess.check_call(["git", "am", "-3", "libraries/scripts/updater/0002-Fix-spark-pid.patch"])
    subprocess.check_call(["git", "am", "-3", "libraries/scripts/updater/0003-Fix-deprecation.patch"])
